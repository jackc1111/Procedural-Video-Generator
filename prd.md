...
- **Export Options**: MP4, GIF, PNG (для кадрів), різні роздільні здатності.
...
- FR6: Конфігурація через JSON/YAML (розмір, FPS, тривалість).
...
- **Modules**:
  ...
  - `utils.py`: Допоміжні функції (конфіг, помилки).
- **Workflow**:
